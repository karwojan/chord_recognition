...
odpowiednim formacie, w większości \filetype{webm}, czasami \filetype{mp4}). Wszystkie pobrane pliki
zapisywane są w katalogu \url{data/audio}. Dodatkowo do pliku indeksu dodawana jest nowa kolumna
...
Parametr \code{song\_multiplier} pozwala uniknąć występowania zbyt krótki epok, które prowadzą do
...
% do dodania:
% - jakieś rysuneczki do preprocessingu
