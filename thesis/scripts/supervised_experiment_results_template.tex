...
\makebox[\textwidth][c]{\large \textbf{Eksperyment \code{!name!}}} \\ \\
...
\makebox[\textwidth][c]{\textbf{KRZYWE UCZENIA I MACIERZ POMYŁEK}} \\ \\
\makebox[\width][c]{
\includegraphics[width=0.7\textwidth,angle=90]{!curves_path!}
}
\makebox[\width][c]{
\includegraphics[width=0.70\textwidth]{!confusion_matrix_path!}
}
